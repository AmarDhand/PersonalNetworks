...
Date range: August 6, 2018-November 30, 2018
...
File organization: Statistical code in 3 parts, fake data, codebook, and README file all together in the main directory.

File naming: Files names include data last saved, project name, and file type (20180806_PersonalNetworks_code1.R)

File storage location: The files are all stored in the project repository at https://github.com/PersonalNetworks
